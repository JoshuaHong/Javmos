...
public final class JavmosGUI {
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(zoomOutButton, CONTROL_PANEL_WIDTH / 3, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 25, zoomListener, "-", displayBackgroundColor, displayForegroundColor);
        ...
        configureComponent(zoomInButton, CONTROL_PANEL_WIDTH / 3, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 25, zoomListener, "+", displayBackgroundColor, displayForegroundColor);
